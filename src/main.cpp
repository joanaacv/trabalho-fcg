...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 600, "INF01047 - 270178 - Joana Campos", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    LoadTextureImage("../../data/Poliigon_WoodFloorAsh_4186_BaseColor.jpg");   // TextureImage0
    ...
    ObjModel bedsideTableModel("../../data/bedroom_Obj/Objects/Bedside_table/Bedside_table.obj");
    ComputeNormals(&bedsideTableModel);
    BuildTrianglesAndAddToVirtualScene(&bedsideTableModel);

    ObjModel bookStack1Model("../../data/bedroom_Obj/Objects/Book_stack_1/Book_stack_1.obj");
    ComputeNormals(&bookStack1Model);
    BuildTrianglesAndAddToVirtualScene(&bookStack1Model);

    ObjModel bookStack2Model("../../data/bedroom_Obj/Objects/Book_stack_2/Book_stack_2.obj");
    ...
    ObjModel keyboardModel("../../data/bedroom_Obj/Objects/Keyboard/Keyboard.obj");
    ...
    ObjModel picture1Model("../../data/bedroom_Obj/Objects/Picture_1/Picture_1.obj");
    ComputeNormals(&picture1Model);
    BuildTrianglesAndAddToVirtualScene(&picture1Model);

    ObjModel picture2Model("../../data/bedroom_Obj/Objects/Picture_2/Picture_2.obj");
    ComputeNormals(&picture2Model);
    BuildTrianglesAndAddToVirtualScene(&picture2Model);

    ObjModel picture3Model("../../data/bedroom_Obj/Objects/Picture_3/Picture_3.obj");
    ...
    ObjModel wallBookshelfModel("../../data/bedroom_Obj/Objects/Wall_bookshelf/Wall_bookshelf.obj");
    ComputeNormals(&wallBookshelfModel);
    BuildTrianglesAndAddToVirtualScene(&wallBookshelfModel);

    ObjModel wallShelfModel("../../data/bedroom_Obj/Objects/Wall_shelf/Wall_shelf.obj");
    ComputeNormals(&wallShelfModel);
    BuildTrianglesAndAddToVirtualScene(&wallShelfModel);

    ObjModel wardrobeModel("../../data/bedroom_Obj/Objects/Wardrobe/Wardrobe.obj");
    ComputeNormals(&wardrobeModel);
    BuildTrianglesAndAddToVirtualScene(&wardrobeModel);

    ObjModel woodFloorModel("../../data/bedroom_Obj/Objects/Wood_floor/Wood_floor.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3fv(glGetUniformLocation(g_GpuProgramID, "Kd_uniform"), 1, bedmodel.materials[1].diffuse);
        glUniform3fv(glGetUniformLocation(g_GpuProgramID, "Ka_uniform"), 1, bedmodel.materials[1].ambient);
        glUniform3fv(glGetUniformLocation(g_GpuProgramID, "Ks_uniform"), 1, bedmodel.materials[1].specular);
        DrawVirtualObject("Bed_Cube.001"); // 


        model = Matrix_Translate(-4.0f, -1.1f, 0.0f); // Posição da mesa de cabeceira
        glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
        ...
        model = Matrix_Translate(-2.0f, -1.1f, 2.0f); // Posição da pilha de livros 1
        glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
        glUniform1i(g_object_id_uniform, BOOK_STACK_1); 
        DrawVirtualObject("Book_stack_1_Cube.009"); //
        // Desenha a Pilha de Livros 2
        model = Matrix_Translate(-2.0f, -1.1f, -2.0f); // Posição da pilha de livros 2
        glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
        ...
        // Desenha o Assento
        model = Matrix_Translate(-6.0f, -1.1f, 0.0f); // Posição do assento
        glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
        glUniform1i(g_object_id_uniform, SEAT);
        DrawVirtualObject("Seat_Sphere.002"); //

        model = Matrix_Translate(-8.0f, -1.1f, 0.0f) * Matrix_Scale(1.3f, 1.3f, 1.3f); // Posição do assento ampliado
        glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
        glUniform1i(g_object_id_uniform, SEAT);
        DrawVirtualObject("Seat_Sphere.002"); //
        ...
        model = Matrix_Translate(6.0f, 0.0f, 0.0f); // Posição da prateleira de parede
        glUniformMatrix4fv(g_model_uniform, 1, GL_FALSE, glm::value_ptr(model));
...
void LoadShadersFromFiles()
{
    ...
    glUniform1i(glGetUniformLocation(g_GpuProgramID, "TextureImage1"), false);
